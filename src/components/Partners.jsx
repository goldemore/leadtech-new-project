    ...
    <div className='partners_container'>
        <div onClick={prevBtn}>
            <svg width="37" height="31" viewBox="0 0 37 31" fill="none" xmlns="http://www.w3.org/2000/svg">
                <path id="Vector" d="M0.819508 16.0488L15.0296 30.2589C15.1778 30.407 15.3787 30.4902 15.5882 30.4902C15.7976 30.4902 15.9986 30.407 16.1467 30.2589C16.2948 30.1107 16.378 29.9098 16.378 29.7003C16.378 29.4909 16.2948 29.2899 16.1467 29.1418L3.28457 16.2797H36.1139C36.3232 16.2797 36.524 16.1965 36.6721 16.0485C36.8201 15.9004 36.9033 15.6996 36.9033 15.4902C36.9033 15.2809 36.8201 15.0801 36.6721 14.932C36.524 14.784 36.3232 14.7008 36.1139 14.7008H3.28457L16.1467 1.83866C16.2948 1.69053 16.378 1.48962 16.378 1.28012C16.378 1.07063 16.2948 0.869721 16.1467 0.721588C15.9986 0.573455 15.7976 0.490234 15.5882 0.490234C15.3787 0.490234 15.1778 0.573454 15.0296 0.721587L0.819508 14.9317C0.746109 15.005 0.687878 15.0921 0.648151 15.1879C0.608421 15.2838 0.587975 15.3865 0.587975 15.4902C0.587975 15.594 0.608421 15.6967 0.648151 15.7925C0.687878 15.8884 0.746109 15.9755 0.819508 16.0488Z" fill="#EAEAEA"/>
            </svg>
        </div>
        <div className='slide_container'>
            <div className='partners_slide'>
                {partners.map((images, index)=>(
                    <div className='partners_img' key={index}>
